...
% shape functions N1...N4
phiJ = double(subs([N1,N2,N3,N4])); ;
...
fileID = fopen('outputMini2D.cpp','w');
% printing gqPoints
fprintf(fileID,'double FEMMiniElement2D::gqPoints[NUMRULE][NUMGLE] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f },\n';
fprintf(fileID,formatSpec,gqPoints');
fprintf(fileID,'};\n\n');

% printing weights
fprintf(fileID,'double FEMMiniElement2D::gqWeights[NUMRULE] = \n');
fprintf(fileID,'{\n');
formatSpec = ' %.15f,\n';
...
% printing phiJ
fprintf(fileID,'double FEMMiniElement2D::phiJ[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
...
% printing dphiJdl1
fprintf(fileID,'double FEMMiniElement2D::dphiJdl1[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f, %.15f },\n';
...
% printing dphiJdl2
fprintf(fileID,'double FEMMiniElement2D::dphiJdl2[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f, %.15f },\n';
...
fprintf(fileID,'double FEMMiniElement2D::dgqPointsdl1[NUMRULE][NUMGLEP] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f },\n';
for i=1:NUMRULE
...
fprintf(fileID,'double FEMMiniElement2D::dgqPointsdl2[NUMRULE][NUMGLEP] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f },\n';
for i=1:NUMRULE
