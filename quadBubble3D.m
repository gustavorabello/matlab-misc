...
N1  = (2.0*L1-1.0)*L1+32.0*L1*L2*L3*L4; 
N2  = (2.0*L2-1.0)*L2+32.0*L1*L2*L3*L4;
N3  = (2.0*L3-1.0)*L3+32.0*L1*L2*L3*L4;
N4  = (2.0*L4-1.0)*L4+32.0*L1*L2*L3*L4;
N5  = 4.0*L1*L2-64.0*L1*L2*L3*L4;
N6  = 4.0*L2*L3-64.0*L1*L2*L3*L4;
N7  = 4.0*L1*L3-64.0*L1*L2*L3*L4;
N8  = 4.0*L1*L4-64.0*L1*L2*L3*L4;
N9  = 4.0*L2*L4-64.0*L1*L2*L3*L4;
N10 = 4.0*L3*L4-64.0*L1*L2*L3*L4;
N11 = 256*L1*L2*L3*L4;
...
% shape functions N1...N11
phiJ = double(subs([N1,N2,N3,N4,N5,N6,N7,N8,N9,N10,N11]));

% derivatives of shape functions L1
dphiJdl1 = double(subs([dphiJdl11, dphiJdl12, dphiJdl13, dphiJdl14, dphiJdl15, dphiJdl16, dphiJdl17, dphiJdl18, dphiJdl19, dphiJdl110, dphiJdl111]));

% derivatives of shape functions L2
dphiJdl2 = double(subs([dphiJdl21, dphiJdl22, dphiJdl23, dphiJdl24, dphiJdl25, dphiJdl26, dphiJdl27, dphiJdl28, dphiJdl29, dphiJdl210, dphiJdl211]));

% derivatives of shape functions L3
dphiJdl3 = double(subs([dphiJdl31, dphiJdl32, dphiJdl33, dphiJdl34, dphiJdl35, dphiJdl36, dphiJdl37, dphiJdl38, dphiJdl39, dphiJdl310, dphiJdl311]));
...
double(subs(N1+N2+N3+N4+N5+N6+N7+N8+N9+N10+N11))

fileID = fopen('outputQuadBubble3D.cpp','w');
% printing gqPoints
fprintf(fileID,'double FEMQuadBubbleElement3D::gqPoints[NUMRULE][NUMGLE] = \n');
fprintf(fileID,'{\n');
...
% printing weights
fprintf(fileID,'double FEMQuadBubbleElement3D::gqWeights[NUMRULE] = \n');
fprintf(fileID,'{\n');
formatSpec = ' %.15f,\n';
...
% printing phiJ
fprintf(fileID,'double FEMQuadBubbleElement3D::phiJ[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f },\n';
fprintf(fileID,formatSpec,phiJ');
fprintf(fileID,'};\n\n');

% printing dphiJdl1
fprintf(fileID,'double FEMQuadBubbleElement3D::dphiJdl1[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f },\n';
...
% printing dphiJdl2
fprintf(fileID,'double FEMQuadBubbleElement3D::dphiJdl2[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f },\n';
...
% printing dphiJdl3
fprintf(fileID,'double FEMQuadBubbleElement3D::dphiJdl3[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f, %.15f },\n';
...
fprintf(fileID,'double FEMQuadBubbleElement3D::dgqPointsdl1[NUMRULE][NUMGLEP] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f, %.15f },\n';
for i=1:NUMRULE
...
fprintf(fileID,'double FEMQuadBubbleElement3D::dgqPointsdl2[NUMRULE][NUMGLEP] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f, %.15f },\n';
for i=1:NUMRULE
...
fprintf(fileID,'double FEMQuadBubbleElement3D::dgqPointsdl3[NUMRULE][NUMGLEP] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.15f, %.15f, %.15f, %.15f },\n';
for i=1:NUMRULE
