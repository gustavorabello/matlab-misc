...
% shape functions N1...N7
phiJ = double(subs([N1,N2,N3,N4,N5,N6,N7]));

% derivatives of shape functions L1
dphiJdl1 = double(subs([dphiJdl11, dphiJdl12, dphiJdl13, dphiJdl14, dphiJdl15, dphiJdl16, dphiJdl17]));

% derivatives of shape functions L2
dphiJdl2 = double(subs([dphiJdl21, dphiJdl22, dphiJdl23, dphiJdl24, dphiJdl25, dphiJdl26, dphiJdl27]));
...
double(subs(N1+N2+N3+N4+N5+N6+N7))

fileID = fopen('outputQuadBubble2D.cpp','w');
% printing gqPoints
fprintf(fileID,'double FEMQuadBubbleElement2D::gqPoints[NUMRULE][NUMGLE] = \n');
fprintf(fileID,'{\n');
...
% printing weights
fprintf(fileID,'double FEMQuadBubbleElement2D::gqWeights[NUMRULE] = \n');
fprintf(fileID,'{\n');
formatSpec = ' %.12f,\n';
...
% printing phiJ
fprintf(fileID,'double FEMQuadBubbleElement2D::phiJ[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.12f, %.12f, %.12f, %.12f, %.12f, %.12f, %.12f },\n';
fprintf(fileID,formatSpec,phiJ');
fprintf(fileID,'};\n\n');

% printing dphiJdl1
fprintf(fileID,'double FEMQuadBubbleElement2D::dphiJdl1[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.12f, %.12f, %.12f, %.12f, %.12f, %.12f, %.12f },\n';
...
% printing dphiJdl2
fprintf(fileID,'double FEMQuadBubbleElement2D::dphiJdl2[NUMRULE][NUMGLEU] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.12f, %.12f, %.12f, %.12f, %.12f, %.12f, %.12f },\n';
...
fprintf(fileID,'double FEMQuadBubbleElement2D::dgqPointsdl1[NUMRULE][NUMGLEP] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.12f, %.12f, %.12f },\n';
for i=1:NUMRULE
...
fprintf(fileID,'double FEMQuadBubbleElement2D::dgqPointsdl2[NUMRULE][NUMGLEP] = \n');
fprintf(fileID,'{\n');
formatSpec = ' {%.12f, %.12f, %.12f },\n';
for i=1:NUMRULE
